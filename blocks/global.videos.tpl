...
<div class="w-full flex flex-col gap-4 sm:gap-6">
    ...
    <!-- Sub Videos Grid (Horizontal Row) -->
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
        <!-- BEGIN: sub_video -->
        <div onclick="playSelectedVideo('{SUB_VIDEO.youtube_id}', '{SUB_VIDEO.url}')" class="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-md group cursor-pointer block border border-slate-200 bg-slate-900 transition-all hover:scale-[1.02]">
            ...
            <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-4 text-white">
                <div class="w-8 h-8 rounded-full bg-red-600/90 flex items-center justify-center mb-2 shadow group-hover:scale-110 transition-transform">
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current translate-x-0.5" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg>
                </div>
                <h5 class="font-['Inter'] font-semibold text-xs sm:text-sm leading-snug line-clamp-2">{SUB_VIDEO.title}</h5>
            </div>
        </div>
        <!-- END: sub_video -->
    </div>
    ...
    <div class="w-full flex flex-col gap-4 sm:gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
            <div onclick="document.getElementById('main-video-demo-iframe').src='https://www.youtube.com/embed/HmopevVXBNI?autoplay=1'" class="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-md group cursor-pointer border border-slate-200 bg-slate-900 hover:scale-[1.02] transition-all">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-4 text-white">
                    <div class="w-8 h-8 rounded-full bg-red-600/90 flex items-center justify-center mb-2 shadow"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current translate-x-0.5" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg></div>
                    <h5 class="font-['Inter'] font-semibold text-xs sm:text-sm line-clamp-2">Video Giới Thiệu Hệ Thống</h5>
                </div>
            </div>
            <div onclick="document.getElementById('main-video-demo-iframe').src='https://www.youtube.com/embed/5qap5aO4i9A?autoplay=1'" class="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-md group cursor-pointer border border-slate-200 bg-slate-900 hover:scale-[1.02] transition-all">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-4 text-white">
                    <div class="w-8 h-8 rounded-full bg-red-600/90 flex items-center justify-center mb-2 shadow"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current translate-x-0.5" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg></div>
                    <h5 class="font-['Inter'] font-semibold text-xs sm:text-sm line-clamp-2">Lễ Khai Giảng Và Kỷ Niệm</h5>
                </div>
            </div>
            <div onclick="document.getElementById('main-video-demo-iframe').src='https://www.youtube.com/embed/dQw4w9WgXcQ?autoplay=1'" class="aspect-[4/3] relative rounded-2xl overflow-hidden shadow-md group cursor-pointer border border-slate-200 bg-slate-900 hover:scale-[1.02] transition-all">
                ...
                <div class="absolute inset-0 bg-gradient-to-t from-black/90 via-black/40 to-transparent flex flex-col justify-end p-4 text-white">
                    <div class="w-8 h-8 rounded-full bg-red-600/90 flex items-center justify-center mb-2 shadow"><svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 fill-current translate-x-0.5" viewBox="0 0 24 24"><path d="M8 5v14l11-7z"/></svg></div>
                    <h5 class="font-['Inter'] font-semibold text-xs sm:text-sm line-clamp-2">Hội Thảo Khoa Học &amp; Đổi Mới</h5>
                </div>
            </div>
        </div>
    </div>
