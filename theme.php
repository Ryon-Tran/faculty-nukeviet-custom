...
function nv_site_theme($contents, $full = true)
{
    ...
    $html_links[] = [
        'rel' => 'stylesheet',
        'href' => NV_STATIC_URL . 'themes/' . $global_config['module_theme'] . '/css/custom.css?v=2'
    ];
    ...
    $xtpl->assign('LOGO_ABSOLUTE', preg_match('/^https?:\/\//i', $logo_src) ? $logo_src : NV_MY_DOMAIN . $logo_src);
